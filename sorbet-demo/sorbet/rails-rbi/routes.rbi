...
module GeneratedUrlHelpers
  # Sigs for route /external_services(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def external_services_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def external_services_url(*args, **kwargs); end

  # Sigs for route /external_services/:id(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def external_service_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def external_service_url(*args, **kwargs); end
